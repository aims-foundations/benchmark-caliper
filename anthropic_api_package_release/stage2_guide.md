...
```bash
EXPERT=expert_7f59a7837eda
BENCH=expert_7f59a7837eda__ltzglue
...
(DrBenchmark / hospital clinician use case) for expert Expert 7f59.
...
export EXPERT=expert_7f59a7837eda
